...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"/home/ahlemzenache/Documents/polarfire-soc-video-kit-reference-design_READ_WRITECopie/VKPFSOC_JPEG_WRITE_READ/synthesis/VKPFSOC_TOP.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {/home/ahlemzenache/Documents/polarfire-soc-video-kit-reference-design_READ_WRITECopie/VKPFSOC_JPEG_WRITE_READ/designer/VKPFSOC_TOP} \
    -design VKPFSOC_TOP \
    -fam PolarFireSoC \
    -die PA5SOC250TS \
    -pkg fcg1152 \
