...
import_files -library work -hdl_source script_support/hdl/JPEG_WRITE_READ/apb_wrapper.v
import_files -library work -hdl_source script_support/hdl/JPEG_WRITE_READ/jpeg_control_fsm.v
import_files -library work -hdl_source script_support/hdl/JPEG_WRITE_READ/jls_encoder.v
#import_files -library work -hdl_source script_support/hdl/JPEG_WRITE_READ/ram8bit_input.v
