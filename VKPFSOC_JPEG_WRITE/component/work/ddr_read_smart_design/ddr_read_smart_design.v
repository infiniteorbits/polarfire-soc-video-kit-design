//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Wed Jul  1 15:59:55 2026
// Version: 2025.1 2025.1.0.14
//////////////////////////////////////////////////////////////////////

`timescale 1ns / 100ps

// ddr_read_smart_design
module ddr_read_smart_design(
    // Inputs
    apb_pin,
    // Outputs
    A,
...
wire          CK0_N_net_0;
wire          CKE_0_net_0;
wire          CLK_GEN_C4_0_CLK;
wire          CLK_GEN_C5_0_CLK;
wire          CS_N_net_0;
...
// Inversions
//--------------------------------------------------------------------
assign REFCLK_N_IN_POST_INV0_0      = ~ CLK_GEN_C5_0_CLK;
assign REF_CLK_PAD_N_IN_POST_INV1_0 = ~ CLK_GEN_C4_0_CLK;
//--------------------------------------------------------------------
...
//--------------------------------------------------------------------
//--------CLK_GEN_C4
CLK_GEN_C4 CLK_GEN_C4_0(
        // Outputs
        .CLK ( CLK_GEN_C4_0_CLK ) 
        );

//--------CLK_GEN_C5
CLK_GEN_C5 CLK_GEN_C5_0(
        // Outputs
        .CLK ( CLK_GEN_C5_0_CLK ) 
        );
...
VKPFSOC_TOP VKPFSOC_TOP_0(
        ...
        .REFCLK                      ( CLK_GEN_C5_0_CLK ),
        .REF_CLK_PAD_N               ( REF_CLK_PAD_N_IN_POST_INV1_0 ),
        .REF_CLK_PAD_P               ( CLK_GEN_C4_0_CLK ),
