# Creating SmartDesign "DDR_WRITE_JPEG"
set sd_name {DDR_WRITE_JPEG}
...
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {data_packer_jpeg} -hdl_file {hdl\data_packer_jpeg.v} -instance_name {data_packer_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_0:frame_end_i" "frame_end_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_0:frame_end_o" "ddr_write_controller_enc_0:eof_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_0:reset_i" "ddr_write_controller_enc_0:encoder_en_i" "encoder_en_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_0:sys_clk_i" "ddr_write_controller_enc_0:wrclk_i" "sys_clk_i" "video_fifo_0:wclock_i" }
...
# Generate SmartDesign "DDR_WRITE_JPEG"
