...
module apb_wrapper (
 ...
 //width DDR_Read (i_w + 1)
  ...
  reg [13:0]  reg_ih;
  reg [7:0]   reg_near;
  reg [7:0]  reg_ddr_base_addr;   // NOUVEAU : adresse DDR source
  ...
  always @(posedge pclk) begin
    if (~presetn) begin
      ...
      reg_sof          <= 1'b0;
        reg_iw <= 14'b00000000001110; // 14
        reg_ih <= 14'b00000000000000; // 0
      reg_near         <= 8'b0;
      prdata           <= 32'b0;
      pready           <= 1'b0;
      reg_ddr_base_addr <= 7'h0;
      ...
      if (psel) begin
        ...
        if (pwrite) begin
          ...
          case (paddr[7:0])
            ...
            8'h14: begin // Adress 0x14 : DDR base addr
          ...
          case (paddr[7:0])
            ...
            8'h14:   begin // Address 0x14: DDR base addr
