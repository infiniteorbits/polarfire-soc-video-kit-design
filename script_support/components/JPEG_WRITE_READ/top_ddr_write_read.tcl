...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_ARBITER_PF_C0_0:reset_i" "DDR_RESETN" "DDR_Read_C0_0:reset_i" "DDR_WRITE_JPEG_0:reset_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_AXI4_ARBITER_PF_C0_0:sys_clk_i" "DDR_Read_C0_0:ddr_clk_i" "DDR_WRITE_JPEG_0:ddr_clk_i" "ddr_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Read_C0_0:pixel_clk_i" "DDR_WRITE_JPEG_0:sys_clk_i" "Sys_clk" "jpeg_top_1:clk_sys" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"jpeg_top_1:resetn" "sys_resetn" }
