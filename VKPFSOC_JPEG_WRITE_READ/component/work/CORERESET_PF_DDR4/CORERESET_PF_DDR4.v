//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Sun Aug  2 14:30:01 2026
...
//////////////////////////////////////////////////////////////////////
/*
# Exporting Component Description of CORERESET_PF_DDR4 to TCL
# Family: PolarFireSoC
# Part Number: MPFS250TS-1FCG1152I
# Create and Configure the core component CORERESET_PF_DDR4
create_and_configure_core -core_vlnv {Actel:DirectCore:CORERESET_PF:2.3.100} -component_name {CORERESET_PF_DDR4} -params { }
# Exporting Component Description of CORERESET_PF_DDR4 to TCL done
*/

// CORERESET_PF_DDR4
module CORERESET_PF_DDR4(
    // Inputs
    BANK_x_VDDI_STATUS,
    BANK_y_VDDI_STATUS,
    CLK,
...
// Component instances
//--------------------------------------------------------------------
//--------CORERESET_PF_DDR4_CORERESET_PF_DDR4_0_CORERESET_PF   -   Actel:DirectCore:CORERESET_PF:2.3.100
CORERESET_PF_DDR4_CORERESET_PF_DDR4_0_CORERESET_PF CORERESET_PF_DDR4_0(
        // Inputs
        .CLK                ( CLK ),
        .EXT_RST_N          ( EXT_RST_N ),
