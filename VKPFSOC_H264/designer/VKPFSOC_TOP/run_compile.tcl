...
set_partition_info -name "/VKPFSOC_TOP" -timestamp "1772714878"
set_partition_info -name "/VKPFSOC_TOP/VKPFSOC_TOP" -timestamp "1772714785"
set_partition_info -name "/VKPFSOC_TOP/VKPFSOC_TOP" -timestamp "1772714785"
set_compile_info \
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"/home/ahlemzenache/Documents/polarfire-soc-video-kit-reference-design (Copie)/VKPFSOC_H264/synthesis/VKPFSOC_TOP.vm"}
set_compile_info \
    -category {"Options"} \
