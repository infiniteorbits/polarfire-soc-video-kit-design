//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Mon Mar  9 13:39:41 2026
...
wire   [7:0]  jpeg_top_1_ram_read_addr;
wire          jpeg_top_1_sof_flag;
...
//--------------------------------------------------------------------
assign line_gap_i_const_net_0       = 16'h0000;
assign horz_resl_i_const_net_0      = 16'h0005;
...
DDR_Read_C0 DDR_Read_C0_0(
        ...
        .ddr_clk_i          ( sys_clk_i ),
        .frame_start_i      ( jpeg_top_1_sof_flag ),
        .read_en_i          ( read_en_i ),
        ...
        .frame_start_addr_i ( jpeg_top_1_ram_read_addr ),
